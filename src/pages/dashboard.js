...
export default function Dashboard() {
	...
	return (
		<Layout title={"Dashboard"}>
			...
			<div className="p-8 bg-gradient-to-tl to-[#141414] from-[#151515] rounded-3xl overflow-hidden" data-aos="fade-up" data-aos-delay="100">
				<div className="flex flex-wrap items-start justify-between -mx-10 lg:divide-x lg:divide-neutral-800 gap-y-6">
					<div className="w-full md:w-1/2 lg:w-1/3 px-10">
						...
						<Link href={"/signin/create"} className="text-white leading-7 hover:text-gold duration-300 mt-5 block">
					...
					<div className="w-full md:w-1/2 lg:w-1/3 px-10 md:border-l border-neutral-800 lg:border-l-0 border-t border-b pt-5 pb-5 md:border-t-0 md:border-b-0 md:pt-0 md:pb-0">
						...
						<Link href={"/document/upload"} className="text-white leading-7 hover:text-gold duration-300 block mt-5">
					...
					<div className="w-full md:w-1/2 lg:w-1/3 px-10">
						...
						<Link href={"/document/uploaded"} className="text-white leading-7 hover:text-gold duration-300 block mt-5">
